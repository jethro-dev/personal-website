...
export const LatestBlogPosts = async ({}: Props) => {
  ...
  return (
    <div
      id="blogs"
      className="py-40 dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative"
    >
      ...
      <div className="container">
        ...
        <div className="relative mt-10 flex flex-col lg:flex-row items-stretch justify-between gap-4">
